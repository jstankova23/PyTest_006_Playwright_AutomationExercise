...
# test volá fixture 'temp_user', která nejdříve vytvoří unikátního dočasného uživatele výhradně pro tento test, 
# fixture 'temp_user' nechá provést test na pozitivní přihlášení uživatele, který má na konci uživatele vymazat, ale fixture po skončení testu
# výmaz uživatele kontroluje a pokud ho tento test nesmaže (např. kvůli spadnutí před výmazem uživatele), provede výmaz uživatele fixture
def test_login_positive(page: Page, temp_user):
    # 1. Launch browser; 
