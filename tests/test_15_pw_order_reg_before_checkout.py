...
def test_order_reg_before_checkout(page: Page):
    ...
    product_6 = products.filter(has=page.locator("a[data-product-id='6']")).first # vyhledání první karty produktu z mřížky (products), která obsahuje odkaz na detail produktu s daným ID
    ...
    product_7 = products.filter(has=page.locator("a[href='/product_details/7']")).first
